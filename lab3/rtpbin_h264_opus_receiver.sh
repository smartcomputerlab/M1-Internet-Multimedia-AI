gst-launch-1.0 -v rtpbin name=rtpbin  \
     ...
     rtpbin. ! queue ! rtph264depay ! h264parse ! avdec_h264 ! queue ! videoconvert ! xvimagesink \
      ...
      udpsrc caps="application/x-rtp,media=(string)audio,clock-rate=(int)16000, encoding-name=(string)OPUS, encoding-params=(string)1, payload=(int)110" \
      port=5002 ! rtpbin.recv_rtp_sink_1  \
      rtpbin. !  queue ! rtpopusdepay ! opusdec ! audioconvert ! alsasink \
